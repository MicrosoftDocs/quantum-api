---
uid: Microsoft.Quantum.Simulation.Simulators.Tests.Circuits.Generics.UpToPhaseCCNOT2
...
```qsharp
operation UpToPhaseCCNOT2 (control1 : Qubit, control2 : Qubit, target : Qubit) : Unit is Adj
```
