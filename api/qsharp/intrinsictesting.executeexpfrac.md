---
uid: IntrinsicTesting.ExecuteExpFrac
title: ExecuteExpFrac operation
ms.date: 3/24/2021 12:00:00 AM
ms.topic: managed-reference
qsharp.kind: operation
qsharp.namespace: IntrinsicTesting
qsharp.name: ExecuteExpFrac
qsharp.summary: ''
---

# ExecuteExpFrac operation
...
```qsharp
operation ExecuteExpFrac (intrinsics : IntrinsicTesting.UnitaryQSharpIntrinsics) : Unit
```
