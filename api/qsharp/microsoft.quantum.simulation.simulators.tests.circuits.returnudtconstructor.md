...
## Output : (([Int](xref:microsoft.quantum.qsharp.valueliterals#int-literals),[Int](xref:microsoft.quantum.qsharp.valueliterals#int-literals)),[Int](xref:microsoft.quantum.qsharp.valueliterals#int-literals)) -> [P2](xref:Microsoft.Quantum.Simulation.Simulators.Tests.Circuits.P2)
