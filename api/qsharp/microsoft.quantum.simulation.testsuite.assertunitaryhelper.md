...
### stateIds : [Int](xref:microsoft.quantum.qsharp.valueliterals#int-literals)[]
...
### unitaryOp : [Qubit](xref:microsoft.quantum.qsharp.valueliterals#qubit-literals)[] => [Unit](xref:microsoft.quantum.qsharp.valueliterals#unit-literal) 
