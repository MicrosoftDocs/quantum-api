...
qsharp.name: R1Frac
qsharp.summary: Applies a rotation about the |1> state by an angle specified as a dyadic fraction.  WARNING: This operation uses the opposite sign convention from Microsoft.Quantum.Intrinsic.R, and does not include the factor of 12 included by Microsoft.Quantum.Intrinsic.R1.
---
